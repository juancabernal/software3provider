...
@Component
public class RecipeUpdateEventPublisher {

    private final RabbitTemplate rabbitTemplate;
    private final RecipeQueueConfig config;

    public RecipeUpdateEventPublisher(RabbitTemplate rabbitTemplate, RecipeQueueConfig config) {
    ...
    public void publish(RecipeRequest request) {
        ...
        rabbitTemplate.convertAndSend(
                ...
                message -> {
                    ...
                    message.getMessageProperties().setHeader("eventType", "RECIPE_UPDATED");
                    return message;
                }
        );
    }
